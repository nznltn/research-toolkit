% This script shows a simple randomisation routine for experimental studies where the order of sample analysis might matter (so random sorting is desired). 
% It is designed to be interactive and can be operated by a user who is not familiar with coding. 

%% The routine section
a=input('Instrument-1 in site-1? Enter yes (y) or no (n):', 's');
if a=='y'
